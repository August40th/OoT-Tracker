    ...
    },
    {
        ...
        chestlist: {
            ['Child Switch Room']: { isAvailable: function () {
                return (!OpenForest || (items.KokiriSword && items.DekuShield && OpenForest)) && items.Ocarina && items.RequiemofSpirit && (items.Boomerang || items.Slingshot || (items.Bombchu && BombchuLogic)); } },
