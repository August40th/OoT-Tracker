   ...
   for (var key in chestlist) {
      if ( chestlist[key].access == "master" && quest == "Vanilla" ) { //Master checks
        ...
        if ( chestlist[key].access == "outdoor" && chestlist[key].type == "ocarina" && OcarinaShuffle == false ) { //Ocarina shuffle in field
            continue;}
        if ( chestlist[key].access !== "outdoor" && chestlist[key].type == "ocarina" && OWERmap == false && OcarinaShuffle == false) { //Ocarina shuffle no OWER
            continue;}
        if ( chestlist[key].access !== "outdoor" && chestlist[key].type == "ocarina" && OWERmap == true && OcarinaShuffle == false ) { //OWER Ocarina shuffle
            continue;}
