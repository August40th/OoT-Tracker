...
function updateMap() {
    for (k = 0; k < dungeons.length; k++) {
        ...
        if (dungeonMarked.length == 0 && document.getElementById("dungeon" + k) !== null) document.getElementById("dungeon" + k).className = "mapspan dungeon " + dungeons[k].canGetChest();
        else if (dungeonMarked.length > 0 && document.getElementById("dungeon" + k) !== null) document.getElementById("dungeon" + k).className = "mapspan dungeon " + dungeons[k].canGetChest() + ((dungeonMarked.indexOf(k) > -1) ? " wayofhero" : " ");
        var DCcount = 0;
        for (var key in dungeons[k].chestlist) {
