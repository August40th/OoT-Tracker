...
function findAngle(x1, y1, x2, y2) {
    ...
    if (y2 < y1 && x2 < x1) angle = angle; //top l
    else if (y2 > y1 && x2 < x1) angle = angle + 55; //bottom l
    else if (y2 < y1 && x2 > x1) angle = angle; //top r
    else if (y2 > y1 && x2 > x1) angle = 260 - angle; //bottom r 
