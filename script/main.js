...
var cookiekeys = ['map', 'iZoom', 'mZoom', 'mOrien', 'mPos', 'glogic', 'prize', 'items', 'qlogic', 'flogic', 'carp', 'smallk', 'bossk', 'sclogic', 'sklogic', 'ocShuff', 'sngShuff', 'eggShuff', 'chulogic'];
var cookieDefault = {
    map:1,
    iZoom:100,
    mZoom:100,
...
function gridItemClick(row, col, corner) {
    ...
    if(medallions[item] !== undefined){
        ...
        if (smallkeys == "Keysanity") {
            ...
            else if (Rescue1 == false && fortresskeys[item] >=  5){
                fortresskeys[item] = 0;
            }
        }
        else {
